...
GHA2DB_EXCLUDE_REPOS='pingcap/tikv,pingcap/pd,pingcap/pd-web,pingcap/chaos-mesh' GHA2DB_PROJECT=tidb PG_DB=tidb GHA2DB_LOCAL=1 gha2db 2021-01-01 0 today now pingcap 2>>errors.txt | tee -a run.log || exit 2

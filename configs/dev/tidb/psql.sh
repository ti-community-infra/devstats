...
GHA2DB_EXCLUDE_REPOS='pingcap/tikv,pingcap/pd,pingcap/pd-web,pingcap/chaos-mesh,pingcap/ticdc-lib,pingcap/tidb-ansible,pingcap/tidb-helper,pingcap/tidb-lightning,pingcap/tikv-client-lib-java,pingcap/etcdv3-gateway,pingcap/tso,pingcap/mysqlrelay,pingcap/tidb-lmdb,pingcap/sqllogictest' 2>>errors.txt | tee -a run.log || exit 2
GHA2DB_PROJECT=tidb PG_DB=tidb GHA2DB_LOCAL=1 gha2db 2021-01-01 0 today now pingcap 2>>errors.txt | tee -a run.log || exit 2

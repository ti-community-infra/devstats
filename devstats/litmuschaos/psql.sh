...
GHA2DB_PROJECT=litmuschaos PG_DB=litmuschaos GHA2DB_LOCAL=1 gha2db 2017-03-15 0 today now 'litmuschaos,openebs/testlib-storage,openebs/litmus' 2>>errors.txt | tee -a run.log || exit 2

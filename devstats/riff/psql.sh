...
GHA2DB_PROJECT=riff PG_DB=riff GHA2DB_LOCAL=1 gha2db 2017-07-28 0 today now 'projectriff,markfisher/sk8s,jldec/projectriff.io,pivotal-cf/pfs-system-testlib,ericbottard/sk8s-go,ericbottard/sk8s-types,ericbottard/kubernetes-model,ericbottard/sk8s-http-gateway,ericbottard/function-sidecar,ericbottard/sk8s-topic-controller' 2>>errors.txt | tee -a run.log || exit 2

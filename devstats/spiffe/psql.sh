...
GHA2DB_EXCLUDE_REPOS='spiffe/spire,spiffe/spire-k8s,spiffe/spire-testlib,spiffe/spire-tutorials,spiffe/spire-examples,spiffe/spire-circleci-testlib' GHA2DB_PROJECT=spiffe PG_DB=spiffe GHA2DB_LOCAL=1 gha2db 2017-08-23 0 today now spiffe 2>>errors.txt | tee -a run.log || exit 2

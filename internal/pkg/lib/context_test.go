...
func TestInit(t *testing.T) {
	...
	for index, test := range testCases {
		...
		// We can't testlib this, because user testlib environment can have those files or not
		// We're forcing skipping that testlib unless this is a special testlib for GitHubOAuth

...
func TestMakeUniqueSort(t *testing.T) {
	...
	for index, test := range testCases {
		...
		if (len(got) > 0 || len(expected) > 0) && !reflect.DeepEqual(got, expected) {
			t.Errorf(
				"testlib number %d, expected '%v', got '%v', testlib case: %+v",
...
func TestOrgIDOrNil(t *testing.T) {
	...
	if result != nil {
		t.Errorf("testlib nil case: expected <nil>, got %v", result)
	}
	result = OrgIDOrNil(&Org{ID: 2})
	if result != 2 {
		t.Errorf("testlib ID=2 case: expected 2, got %v", result)
	}
}
...
func TestRepoNameOrNil(t *testing.T) {
	...
	if result != expected {
		t.Errorf("testlib Name=%s case: expected %s, got %v", expected, expected, result)
	}
}
...
func TestActorLoginOrNil(t *testing.T) {
	...
	if result != expected {
		t.Errorf("testlib Login=%s case: expected %s, got %v", expected, expected, result)
	}
	login := "forbidden"
	expected = "anon-1"
	result = ActorLoginOrNil(&Actor{Login: login}, func(a string) string { return "anon-1" })
	if result != expected {
		t.Errorf("testlib Login=%s case: expected %s, got %v", login, expected, result)
	}
}
...
func TestCompareStringPtr(t *testing.T) {
	...
	if result != true {
		t.Errorf("testlib nil, nil case: expected true, got %v", result)
	}
	result = CompareStringPtr(nil, &s1)
	if result != false {
		t.Errorf("testlib nil, &s1 case: expected false, got %v", result)
	}
	result = CompareStringPtr(&s2, nil)
	if result != false {
		t.Errorf("testlib &s2, nil case: expected false, got %v", result)
	}
	result = CompareStringPtr(&s1, &s2)
	if result != false {
		t.Errorf("testlib &s1, &s2 case: expected false, got %v", result)
	}
	result = CompareStringPtr(&s1, &s1)
	if result != true {
		t.Errorf("testlib &s1, &s1 case: expected true, got %v", result)
	}
...
func TestCompareIntPtr(t *testing.T) {
	...
	if result != false {
		t.Errorf("testlib nil, &i1 case: expected false, got %v", result)
	}
	result = CompareIntPtr(&i2, nil)
	if result != false {
		t.Errorf("testlib &i2, nil case: expected false, got %v", result)
	}
	result = CompareIntPtr(&i1, &i2)
	if result != false {
		t.Errorf("testlib &i1, &i2 case: expected false, got %v", result)
	}
	result = CompareIntPtr(&i1, &i1)
	if result != true {
		t.Errorf("testlib &i1, &i1 case: expected true, got %v", result)
	}
...
func TestCompareFloat64Ptr(t *testing.T) {
	...
	if result != false {
		t.Errorf("testlib nil, &f1 case: expected false, got %v", result)
	}
	result = CompareFloat64Ptr(&f2, nil)
	if result != false {
		t.Errorf("testlib &f2, nil case: expected false, got %v", result)
	}
	result = CompareFloat64Ptr(&f1, &f2)
	if result != false {
		t.Errorf("testlib &f1, &f2 case: expected false, got %v", result)
	}
	result = CompareFloat64Ptr(&f1, &f1)
	if result != true {
		t.Errorf("testlib &f1, &f1 case: expected true, got %v", result)
	}
	...
	if result != true {
		t.Errorf("testlib &f1, &f4 case: expected true, got %v", result)
	}
}
